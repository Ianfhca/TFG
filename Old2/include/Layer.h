...
public:
    Layer(string type_ = "undefined", int numNeurons_ = -1, vector<pair<vector<double>, int>> neuronParams_ = {{{}, -1}}, string connections_ = "undefined", int multisynapses_ = -1, vector<pair<int, int>> sparseConnections_ = {{-1, -1}});
    string getType();
    int getNumNeurons();
